...
public class Admin_UpdateLecture extends javax.swing.JFrame {

    /**
     * Creates new form Admin_UpdateLecture
     */
    public Admin_UpdateLecture() {
        initComponents();
 ...
 // Creation of the void Close to close the windows
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        if (id.isEmpty() || firstname.isEmpty() || lastname.isEmpty() || email.isEmpty() || birth.isEmpty() 
                || phone.isEmpty() || email.isEmpty() || address.isEmpty() || house.isEmpty() || field.isEmpty() || field.isEmpty()) {
            JOptionPane.showMessageDialog(this, " Please Fill all fields");}
        else{
        try {
            File Lecturers = new File ("Lecturer.txt");
            FileReader fr = new FileReader(Lecturers);
            BufferedReader br = new BufferedReader(fr);
            String data;
            ...
            while ((data = br.readLine()) != null) {
                        ...
                        if (tempLecturer.getId().equals(id)) {
                            tempLecturer.setFirstname(firstname);
                            tempLecturer.setLastname(lastname);
                            tempLecturer.setBirth(birth);
                            tempLecturer.setGender(gender);  
                            tempLecturer.setEmail(email);
                            tempLecturer.setphone(phone);
                            tempLecturer.setAddress(address);
                            tempLecturer.setHouse(house);
                            tempLecturer.setField(field);
                            tempLecturer.setYearhired(yearhired);
                        }
                        LecturerList.add(tempLecturer);
                    }
            try (PrintWriter pw = new PrintWriter(new FileWriter(Lecturers, false))) {
                    ...
                    JOptionPane.showMessageDialog(this, "Lecturer Updated Succesfully");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_UpdateLecture.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_UpdateLecture().setVisible(true);
            }
        });
    }
