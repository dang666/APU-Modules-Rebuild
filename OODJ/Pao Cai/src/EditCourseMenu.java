 ...
 * @author DragonKimchi
 */
public class EditCourseMenu extends javax.swing.JFrame {
    ...
    public void setEditCourse(String a, String b, String c, String d, String e){
        //set value to menu
        ...
        //JOptionPane.showMessageDialog(null, "The value is set", "Edit Course", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    private void ConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmActionPerformed
        ...
        cc.EditCourse(a, b, c, d, e, OriginalCourseCode);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditCourseMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditCourseMenu().setVisible(true);
            }
        });
    }
    ...
    EditCourseMenu(String code, String name, String lv, String fees, String duration) {
